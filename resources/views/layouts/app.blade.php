        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @auth
                    {{-- this will show up when not in admin page --}}
                        @if (!request()->is('admin/*'))
                        <ul class="navbar-nav me-auto">
                            <form action="{{ route('search') }}" style="width: 300px">
                                <input type="serch" name="search" class="form-control form-control-sm" placeholder="Search..">
                            </form>
                        </ul>                            
                        @endif
                    @endauth
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <button class="btn shadow-none nav-link" id="acount-dropdown" data-bs-toggle="dropdown">
                                    @if (Auth::user()->avatar)
